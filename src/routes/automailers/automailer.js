...
import BigShipLrUpdate from '../../services/gainer/lsp/BigShip-LrUpdate.js'
import BigShipOrderStatusUpdate from '../../services/gainer/lsp/BigShip-TrackOrder.js'
...
router.route('/BS-LrUpdate').get(BigShipLrUpdate)
router.route('/BS-TrackOrder').get(BigShipOrderStatusUpdate)
