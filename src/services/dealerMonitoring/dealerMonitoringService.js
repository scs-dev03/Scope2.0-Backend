...
--END AS Partnature
      ...
      GROUP BY 
          ppni.PartNumber, Vehiclenumber, PartDesc, part_category, price, ppni.Qty , All_Time_NonStck , cs2.Qty
      HAVING 
          SUM(ppni_val) > 0
      ORDER BY 
          PPNI_Value DESC;
...
try {
        ...
        // console.log(result.recordset);https://6mztnd0t-3000.inc1.devtunnels.ms/
        return result.recordset
} catch (error) {
